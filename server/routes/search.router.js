...
router.get("/:search", rejectUnauthenticated, (req, res) => {
  ...
  axios
    .get(
      `https://api.edamam.com/api/recipes/v2?type=public&q=${search}&app_id=${process.env.REACT_APP_APP_ID}&app_key=${process.env.REACT_APP_API_KEY}&ingr=5-10&field=label&field=image&field=source&field=url&field=ingredientLines`
    )
    .then((response) => {
