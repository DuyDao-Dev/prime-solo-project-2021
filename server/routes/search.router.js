...
router.get("/:search", rejectUnauthenticated, (req, res) => {
  ...
  axios
    .get(
      ...
      `https://api.edamam.com/api/recipes/v2?type=public&q=${search}&${process.env.APP_ID}&app_key=${process.env.API_KEY}&ingr=1-10&imageSize=SMALL&random=true&field=label&field=image&field=url&field=ingredientLines&limit=5`
